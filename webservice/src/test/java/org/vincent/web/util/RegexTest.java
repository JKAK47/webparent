...
/**
 * 正则表达式 测试
 * <p> Created by PengRong on 2018/8/16. </p>
...
public class RegexTest {
		...
		public static String getIP(String domain) {
				...
				if (iAddress == null)
						System.out.println(  "iAddress ==null");
				else {
		...
		public static void main(String[] args) {
				String domain=getDomain("https://mail.qq.com/cgi-bin/frame_html?sid=aFFGa3xMeaLaB1sA&r=6f7dd3881aaebbacf8b7fce31c9783ab\n");
				System.out.println(domain);
				System.out.println(getIP(domain));
				int a = 13;
